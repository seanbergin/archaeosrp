...
The package can be used in two main ways. The main procedure takes a folder location as an input and outputs data recorded from the form as a dataframe. It is called processPDFDirectory(directory to pdfs).
